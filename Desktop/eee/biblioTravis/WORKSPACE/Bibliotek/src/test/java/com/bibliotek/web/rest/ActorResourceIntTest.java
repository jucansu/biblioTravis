...
import com.bibliotek.web.rest.ActorResource;
...
public class ActorResourceIntTest {
    ...
    private static final String DEFAULT_UVUS = "AAAAAAAAAA";
    private static final String UPDATED_UVUS = "BBBBBBBBBB";
    ...
    public void createActor() throws Exception {
        ...
        assertThat(testActor.getCorreo()).isEqualTo(DEFAULT_CORREO);
        assertThat(testActor.getUvus()).isEqualTo(DEFAULT_UVUS);
        assertThat(testActor.getTelefono()).isEqualTo(DEFAULT_TELEFONO);
    }
    ...
    public void getAllActors() throws Exception {
        ...
        restActorMockMvc.perform(get("/api/actors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].uvus").value(hasItem(DEFAULT_UVUS.toString())))
    ...
    public void getActor() throws Exception {
        ...
        restActorMockMvc.perform(get("/api/actors/{id}", actor.getId()))
            ...
            .andExpect(jsonPath("$.uvus").value(DEFAULT_UVUS.toString()))
    ...
    public void updateActor() throws Exception {
        ...
        assertThat(testActor.getCorreo()).isEqualTo(UPDATED_CORREO);
        assertThat(testActor.getUvus()).isEqualTo(UPDATED_UVUS);
        assertThat(testActor.getTelefono()).isEqualTo(UPDATED_TELEFONO);
    }
