...
import { BibliotecaComponent } from 'app/entities/biblioteca/biblioteca.component';
...
describe('Component Tests', () => {
    describe('Biblioteca Management Component', () => {
        let comp: BibliotecaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BibliotecaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bibliotecas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
