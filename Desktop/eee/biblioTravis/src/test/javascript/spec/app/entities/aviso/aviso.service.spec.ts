...
describe('Service Tests', () => {
    describe('Aviso Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AvisoService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new Aviso(0, 'AAAAAAA', 'AAAAAAA', currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Aviso', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        fecha: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Aviso', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        descripcion: 'BBBBBB',
            ...
            it('should return a list of Aviso', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        descripcion: 'BBBBBB',
