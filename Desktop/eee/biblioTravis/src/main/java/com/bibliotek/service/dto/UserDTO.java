...
public class UserDTO {
	...
	public void setBibliotecario(Boolean isBibliotecario) {
    ...
    public UserDTO(User user) {
        ...
        this.setBibliotecario(user.getIsAdministrativo());
        this.setEstudiante(user.getIsEstudiante());
        this.setAdministrativo(user.getIsAdministrativo());
